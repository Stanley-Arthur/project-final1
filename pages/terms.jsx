...
const Terms = () => {
  return (
    <div>
        <div className='flex gap-y-8 pt-28 items-center justify-center  flex-col md:flex-row  min-h-[800px] mt-5'>
...
The Site and its entire contents, features and functionality (including but not limited to all information, software, text, displays, images, video and audio, and the design, selection and arrangement thereof), are owned by SmartSoft Business Solutions, its licensors or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret and other intellectual property or proprietary rights laws.

These Terms of Use permit you to use the Site for your personal, non-commercial use only. You hereby acknowledge that any unauthorized commercial use may violate copyright, trademark and other laws.
...
By making any User Content available through the Site, you grant to the Company a non-exclusive, transferable,
              </p>
            </div>
        </div>
    </div>
